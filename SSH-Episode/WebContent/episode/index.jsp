...
<!-- <script type="text/javascript" src="http://qzonestyle.gtimg.cn/qzone/openapi/qc_loader.js" 
	data-appid="101475887" data-redirecturi="http://www.wlx959.cn/qqlogin" charset="utf-8"></script> -->
	...
	<div class="header-search">
		<div class="content">
			...
			<div class="float-right header-links">
				<button class="btn btn-login js-to-login"
					style="display: <%=flag==0?"inline-block":"none"%>;">
					<p style="padding-left:30px;">登录</p>
				</button>
				<!-- <span id="qq-login"></span> -->
				<!-- 登陆成功，个人信息 -->
				<div class="user-info-box" style="display: <%=flag==1?"block":"none"%>;">
					...
					<div class="user-info-menu" style="display: block;">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(window).scroll(function(){
            ...
            console.log("scrollTOP:%o", srollPos);
            console.log("window height:%o", $(window).height());
            console.log("Document height:%o", $(document).height());
            
            if(($(document).height()) <= totalheight + 200) {//执行添加一页数据!!滚动过快重复加载数据
	...
	function fnCallback_episode(data) {
		...
		if (list != null) {
			for (var i=0; i<list.length; i++) {
				content.append('<a href="episode/'+list[i].episodeId
