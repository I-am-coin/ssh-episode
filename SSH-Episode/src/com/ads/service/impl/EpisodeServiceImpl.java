...
public class EpisodeServiceImpl implements EpisodeService {
	...
	@Override
	public boolean isUserCollect(int userId, int episodeId) {
		return episodeDao.countUserCollect(userId, episodeId) == 1L ? true : false;
	}

	@Override
	public boolean isUserGood(int userId, int episodeId) {
		return episodeDao.countUserGood(userId, episodeId) == 1L ? true : false;
	}
}
